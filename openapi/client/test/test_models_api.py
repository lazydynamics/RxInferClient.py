...
class TestModelsApi(unittest.TestCase):
    ...
    def test_attach_events_to_episode(self) -> None:
    ...
    def test_delete_model_instance(self) -> None:
    ...
    def test_get_available_model(self) -> None:
    ...
    def test_get_model_instance(self) -> None:
    ...
    def test_get_model_instance_parameters(self) -> None:
    ...
    def test_get_model_instance_state(self) -> None:
    ...
    def test_get_model_instances(self) -> None:
