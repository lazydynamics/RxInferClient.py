...
from rxinfer_openapi.api_response import ApiResponse, T as ApiResponseT
import rxinfer_openapi.models
from rxinfer_openapi import rest
from rxinfer_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rxinfer_openapi.models, klass)
